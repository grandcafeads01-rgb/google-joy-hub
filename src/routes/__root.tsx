...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Workspace — Gmail & Drive dashboard" },
      { name: "description", content: "A single dashboard for your Gmail inbox and Google Drive files." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Workspace — Gmail & Drive dashboard" },
